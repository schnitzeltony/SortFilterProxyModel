                                 ...
                                 public ProxyRoleContainer
{
    ...
    Q_INTERFACES(SortFilterProxyModelQmlNamspace::SorterContainer)
    Q_INTERFACES(SortFilterProxyModelQmlNamspace::ProxyRoleContainer)
    ...
    Q_PROPERTY(QQmlListProperty<SortFilterProxyModelQmlNamspace::Sorter> sorters READ sortersListProperty)
    Q_PROPERTY(QQmlListProperty<SortFilterProxyModelQmlNamspace::ProxyRole> proxyRoles READ proxyRolesListProperty)

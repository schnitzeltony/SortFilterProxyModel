...
qmllistcount SorterContainer::count_sorter(QQmlListProperty<Sorter>* list)
{
    QList<Sorter*>* sorters = static_cast<QList<Sorter*>*>(list->data);
    return sorters->count();
}

Sorter* SorterContainer::at_sorter(QQmlListProperty<Sorter>* list, qmllistcount index)
{
    QList<Sorter*>* sorters = static_cast<QList<Sorter*>*>(list->data);

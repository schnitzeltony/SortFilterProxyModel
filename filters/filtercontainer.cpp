...
qmllistcount FilterContainer::count_filter(QQmlListProperty<Filter>* list)
{
    QList<Filter*>* filters = static_cast<QList<Filter*>*>(list->data);
    return filters->count();
}

Filter* FilterContainer::at_filter(QQmlListProperty<Filter>* list, qmllistcount index)
{
    QList<Filter*>* filters = static_cast<QList<Filter*>*>(list->data);

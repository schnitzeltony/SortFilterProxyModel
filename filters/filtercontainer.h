...
Q_DECLARE_INTERFACE(SortFilterProxyModelQmlNamspace::FilterContainer, FilterContainer_iid)

QML_DECLARE_TYPEINFO(SortFilterProxyModelQmlNamspace::FilterContainerAttached, QML_HAS_ATTACHED_PROPERTIES)
